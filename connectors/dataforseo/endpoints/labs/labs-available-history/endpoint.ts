...
export default defineEndpoint({
    meta: {
        ...
        summary: "See from which date historical Labs data exists per " +
            "location.",
        description:
            "Free lookup. Returns rows of date: the dates Labs holds " +
            "history for, to set as first_date / second_date. Search " +
            "matches the date text (e.g. '2026'). To use these values in " +
